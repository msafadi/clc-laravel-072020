          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <!-- Counter - Alerts -->
                <span id="notificationCount" class="badge badge-danger badge-counter">{{ Auth::user()->unreadNotifications()->count() }}</span>
              </a>
              <!-- Dropdown - Alerts -->
              <div id="notifications" class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="{{ $notification->data['action'] }}">
                  <div class="mr-3">
